    ...
    return(
      <div className='container1'>
        <button
          ...
          onClick={this.switchList}>Unanswered</button>
        <button
          className='switchbtn'
          disabled = {this.state.answeredlist}
          onClick={this.switchList}>Answered</button>
...
function mapStateToProps({ questions,authedUser }) {
  ...
  return {
    answered: Object.keys(questions)
      .filter((a)=>
        questions[a].optionOne.votes.includes(authedUser)||questions[a].optionTwo.votes.includes(authedUser))
